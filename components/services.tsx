    ...
    <section id="services" className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          ref={ref}
        >
          <h2 className="text-4xl md:text-5xl poppins font-bold text-gray-900 mb-4">Our Services</h2>
          <p className="text-xl text-gray-600">Premium detailing solutions tailored to your needs</p>
        </motion.div>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-blue-600 transition-all duration-300 glow-blue-hover cursor-pointer"
              >
                <motion.div
                ...
                <h3 className="text-xl poppins font-bold text-gray-900 mb-3">{service.title}</h3>
